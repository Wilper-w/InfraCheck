...
export default function AutoInspectionTab() {
  ...
  return (
    <div>
      <PageHeader title='定时任务' sub='按设定的时间点周期性巡检全部环境，可配置多个时刻（如每天 08:00 与 22:00）' />
    <div style={{ maxWidth: 960, margin: '0 auto' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        <div>
          <div style={{ fontWeight: 600, fontSize: 15 }}>定时任务</div>
      ...
      {!enabled && (
        <Alert
          ...
          content="当前定时任务处于关闭状态，平台仅在手动点击「立即巡检」时执行。"
        />
      )}
